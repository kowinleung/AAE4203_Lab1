...
obs = gt().Gobs(fullfile('Users/kowin/Downloads/AAE4203 Group 7/COM4___9600_251027_020426.obs'));
nav = gt().Gnav(fullfile('Users/kowin/Downloads/AAE4203 Group 7/COM4___9600_251027_020426.nav'));
obs.plot;
obs.plotNSat;
obs.plotSky(nav);
